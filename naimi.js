...
logonya = fs.readFileSync("./murias/thumb.jpg")
...
muriasmd = fs.readFileSync('./murias/murias.png')
...
const isOwner = setting.ownerNumber == m.sender ? true : ["6285651412324@s.whatsapp.net"].includes(m.sender) ? true : false
...
"extendedTextMessage": {
 ...
 'jpegThumbnail': fs.readFileSync("./murias/webpmobile.jpg")
}
	  } 
}
	const kmd = (teks) => {
...
thumbnail: fs.readFileSync("./murias/webpmobile.jpg"),
mediaType:1,
mediaUrl: 'https://www.instagram.com/Drizasri',
sourceUrl: "https://www.instagram.com/Drizasri"}}}, { quoted: m })
}
try {
...
//SETINGAN
let muriasset = global.db.settings[botNumber]
if (typeof muriasset !== 'object') global.db.settings[botNumber] = {}
if (muriasset) {
if (!isNumber(muriasset.status)) muriasset.status = 0
if (!('autobio' in muriasset)) muriasset.autobio = false
if (!('templateImage' in muriasset)) muriasset.templateImage = false
if (!('templateVideo' in muriasset)) muriasset.templateVideo = false
if (!('templateGif' in muriasset)) muriasset.templateGif = false
if (!('templateMsg' in muriasset)) muriasset.templateMsg = false
if (!('templateDocument' in muriasset)) muriasset.templateDocument = true
...
*Terimakasih telah mendapatkan diri ke database Murias berikut adalah infonya*\n\n*●Nama : ${pushname}*\n*●Nomor : ${sender.split('@')[0]}*\n*●Pengguna : ${register.length}*\n*●SN : ${serialUser}*\n\n*Gunakan bot sewajarnya*`
...
url: 'https://instagram.com/Drizasri'
}
}, {
quickReplyButton: {
displayText: 'MENU',
...
muriasmd = fs.readFileSync('./murias/murias.png')
let txtit = anuuh
naimi.sendMessage(from, { caption: anuuh, image: Imgnah, templateButtons: btn886, footer: `© ${setting.botName} `, mentions: [sender] })
...
{ buttonId: 'jodohku', buttonText: { displayText: 'Jodohku' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, jawab, ` © ${setting.botName} `, m, {mentions: ments})
}
break
case '͏͏jodohku͏͏': {
  if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
let member = participants.map(u => u.id)
let me = m.sender
let jodoh = '6285651412324@s.whatsapp.net'
let jawab = `👫Jodoh mu adalah
...
{ buttonId: 'jadian', buttonText: { displayText: 'Jodohku' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, jawab, ` © ${setting.botName} `, m, {mentions: menst})
}
break
case 'join': {
if (!isOwner) return reply(mess.owner)
...
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, `Mode Group`, ` © ${setting.botName} `, m)
...
{ buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, `Mode Edit Info`, ` © ${setting.botName} `, m)
...
quickReplyButton: {
 ...
 muriasmd = fs.readFileSync('./murias/murias.jpg')
 let txt = `「 Broadcast Bot 」\n\n${text}`
 naimi.send5ButImg(i, txt, ` © ${setting.botName} `, muriasmd, btn)
    }
...
naimi.sendListMsg(m.chat, `Pilih salah satu mode menu di bawah`, `© ${setting.botName} `, '*CHANGE MENU*', `Click Here`, sections, m)
}
break
...
quickReplyButton: {
 ...
 muriasmd = fs.readFileSync('./murias/murias.jpg')
 let txt = `「 Broadcast Bot 」\n\n${text}`
 naimi.send5ButImg(yoi, txt, ` © ${setting.botName} `, muriasmd, btn)
}
...
{
title: "© CREDIT",
rows: [{title: "𝗢𝗪𝗡𝗘𝗥 𝗕𝗢𝗧", rowId: `owner`, description: `Owner `},
{title: "𝗜𝗡𝗙𝗢 𝗕𝗢𝗧", rowId: `info`, description: `Info `},
{title: "𝗜𝗡𝗙𝗢 𝗢𝗪𝗡𝗘𝗥", rowId: `infoowner`, description: `Info owner`}
]
}, 
]
naimi.sendListMsg(m.chat, `Hallo ${pushname} ${ucapanWaktu}\nPilih salah satu menu di bawah`,`*© MuriasMD*`, `*LIST MENU MURIAS MD*`, `Click Here`, sections, m)
///////MENU
break
case 'cerpenmenu':
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
 if (args.length < 1) return reply(`Penggunaan ${prefix + command} 6285651412324|Hallo`)
nom = q.split("|")[0]
nom2 = q.split("|")[1]
...
if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
if (!q) return reply(`Example : ${prefix + command} Murias`) 
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
 reply(mess.wait)
 let link
...
naimi.sendMessage(m.chat, { image: { url: anu }, caption: `*© Powered by murias*\n\nJangan lupa donet :)` }, { quoted: m })
 }
break
case '3dbox':
  if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
...
maker.textpro("https://textpro.me/3d-box-text-effect-online-880.html", [
    `${q}`,])
.then((data) => naimi.sendMessage(m.chat, { image: { url: data }, caption: `*© Powered by murias*\n\nJangan lupa donet :)` }, { quoted: m }))
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
if(!q) return reply(`Penggunaan ${prefix + command} Murias|Md`)
reply(mess.wait)
teks1 = q.split("|")[0]
teks2 = q.split("|")[1]
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
naimi.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${` © ${setting.botName} `}.mp3`}, { quoted : m })
}
confirmlimit(sender, 1)
break
...
naimi.sendMessage(from, {video:{url:i.url}, caption:`Type : ${i.type}`, mimetype:'video/mp4'}, {quoted:m})
  ...
  try {
    reply(mess.wait)
  naimi.sendMessage(from, {image:{url:args[0]}, caption:' © Powered by Murias'}, {quoted:m})
  } catch {
reply("Linknya Error")
}
break
...
naimi.sendMessage(from, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, templateButtons: bton, footer: `© ${setting.botName} `, mentions: [sender] })
confirmlimit(sender, 1)
})
}
break
...
if (!m.quoted.isBaileys) return reply( `Hanya Bisa Membalas Pesan Dari `)
...
muriaschi = pinnya
let txt99 = `Result : ${q}`
naimi.send5ButImg(from, txt99, `© ${setting.botName} `, muriaschi, btn99)
confirmlimit(sender, 1)
break
case 'couple': {
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
case 'nomerhoki': case 'nomorhoki': {
  if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
    if ( checklimitUser(sender) <= 0) return reply(limitabis) 
if (!Number(text)) return reply( `Example : ${prefix + command} 6285651412324`)
...
await naimi.sendButtonText(m.chat, buttons, '_Kamu tidak sedang berada di anonymous chat_', `© ${setting.botName} `)
    return false
}
...
await naimi.sendButtonText(m.chat, buttons, `_Kamu masih berada di dalam anonymous chat, menunggu partner_`, ` © ${setting.botName} `, m)
 return false
}
...
{ buttonId: 'keluar', buttonText: { displayText: 'Stop' }, type: 1 }
    ...
    await naimi.sendButtonText(room.a, buttons, `_Partner ditemukan!_`, ` © ${setting.botName} `, m)
    room.b = m.sender
    room.state = 'CHATTING'
    await naimi.sendButtonText(room.b, buttons, `_Partner ditemukan!_`, ` © ${setting.botName} `, m)
} else {
    let id = + new Date
    this.anonymous[id] = {
id,
...
{ buttonId: 'keluar', buttonText: { displayText: 'Stop' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, '_Menunggu partner..._', `© ${setting.botName} `, m)
}
break
}
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
muriasmddd = await reSize(`./murias/murias.png`, 200, 200) 
let bton = [{
urlButton: {
displayText: 'DONASI',
url: 'https://saweria.co/laxirmods'
}
}, {
urlButton: {
displayText: 'INSTAGRAM',
...
naimi.sendMessage(from, { caption: menulist, image: global.thumb, templateButtons: bton, footer:`© ${setting.botName} `, mentions: [sender] })
} else if (setbot.templateGif) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, gifPlayback: true, templateButtons: bton, footer: `© ${setting.botName} `, mentions: [sender] })
} else if (setbot.templateVid) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, templateButtons: bton, footer: `© ${setting.botName} `, mentions: [sender] })
} else if (setbot.templateVideo) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, templateButtons: bton, footer: `© ${setting.botName} `, mentions: [sender] })
} else if (setbot.templateMsg) {
naimi.sendMessage(from, { text: menulist, templateButtons: buttonsDefault, footer: `© ${setting.botName} `, mentions: [sender] })
...
naimi.sendMessage(m.chat, { caption: menulist, document: fs.readFileSync('./murias/murias.xlsx'), mimetype: `${docs}`, jpegThumbnail:fs.readFileSync("./murias/menu.png"), fileName: `${setting.botName}`, templateButtons: buttonmenu, footer: `© ${setting.botName} `, mentionedJid: [m.sender] })
}
setTimeout( () => {
