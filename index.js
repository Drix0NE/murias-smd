...
async function startnaimi() {
    const naimi = naimiConnect({
        ...
        browser: ['Murias Multi Device','Safari','1.0.0'],
        auth: state,
        version: getVersionWaweb() || [2, 2204, 13]
    })
    console.log(color('[MURIAS MD]', 'cyan'), color(`
DDDDDDDDDDDDD      RRRRRRRRRRRRRRRRR   IIIIIIIIIIXXXXXXX       XXXXXXXXXXXXXX       XXXXXXX
D::::::::::::DDD   R::::::::::::::::R  I::::::::IX:::::X       X:::::XX:::::X       X:::::X
D:::::::::::::::DD R::::::RRRRRR:::::R I::::::::IX:::::X       X:::::XX:::::X       X:::::X
DDD:::::DDDDD:::::DRR:::::R     R:::::RII::::::IIX::::::X     X::::::XX::::::X     X::::::X
  D:::::D    D:::::D R::::R     R:::::R  I::::I  XXX:::::X   X:::::XXXXXX:::::X   X:::::XXX
  D:::::D     D:::::DR::::R     R:::::R  I::::I     X:::::X X:::::X      X:::::X X:::::X   
  D:::::D     D:::::DR::::RRRRRR:::::R   I::::I      X:::::X:::::X        X:::::X:::::X    
  D:::::D     D:::::DR:::::::::::::RR    I::::I       X:::::::::X          X:::::::::X     
  D:::::D     D:::::DR::::RRRRRR:::::R   I::::I       X:::::::::X          X:::::::::X     
  D:::::D     D:::::DR::::R     R:::::R  I::::I      X:::::X:::::X        X:::::X:::::X    
  D:::::D     D:::::DR::::R     R:::::R  I::::I     X:::::X X:::::X      X:::::X X:::::X   
  D:::::D    D:::::D R::::R     R:::::R  I::::I  XXX:::::X   X:::::XXXXXX:::::X   X:::::XXX
DDD:::::DDDDD:::::DRR:::::R     R:::::RII::::::IIX::::::X     X::::::XX::::::X     X::::::X
D:::::::::::::::DD R::::::R     R:::::RI::::::::IX:::::X       X:::::XX:::::X       X:::::X
D::::::::::::DDD   R::::::R     R:::::RI::::::::IX:::::X       X:::::XX:::::X       X:::::X
DDDDDDDDDDDDD      RRRRRRRR     RRRRRRRIIIIIIIIIIXXXXXXX       XXXXXXXXXXXXXX       XXXXXXX`, 'red'))
console.log(color('[MURIAS MD]', 'cyan'), color('OWNER SEDANG ONLINE SEKARANG!', 'yellow'))

	console.log(color('[MURIAS MD]', 'cyan'), color('SELAMAT DATANG OWNER ><', 'yellow'))
	
	console.log(color('======================', 'fuchsia'),color('\n[MURIAS MD V1]', 'pink'),color('\nTHANKS TO: \n➸ ALLAH SWT\n➸ Drizasri.\nPenyedia scrape dan module lainnya', 'yellow'),color('\n======================', 'fuchsia'))
	console.log(color('\nADA SARAN ATAU MASUKAN WA : +6285651412324', 'red'))
    store.bind(naimi.ev)
...
let buttonMessage = {
document: fs.readFileSync('./murias/murias.xlsx'),
mimetype: docs,
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://www.instagram.com/drizasri`,
